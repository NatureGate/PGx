...
# ax2.set_ylabel('diplotype (%)', color='darkred', fontsize=12)
# ax2.tick_params(axis='y', labelcolor='darkred')
# ax2.set_ylim(0, 110)  # 设置概率轴范围（0-110%）

# 设置x轴标签（基因名称）
ax1.set_xticks(x)
ax1.set_xticklabels(merged_sorted[gene_column], rotation=45, ha='right')
...
# 保存并显示
plt.tight_layout()
output_path = os.path.join(folder_path, 'grouped_bar_plot.png')
