...
task pharmCatTask{
  ...
  command {
    ...
    source activate base
    java -jar /home/stereonote/pharmcat-3.0.1-all.jar -vcf ~{file}   -reporterJson --output-dir .  -reporterCallsOnlyTsv
...
task PostPharmCat {
    ...
    runtime {
        docker_url: "stereonote_hpc/longrui_72bd9c34cb234250bb13be8af0c3840a_private:latest"
        req_cpu: 1
        req_memory: "3Gi"
  }
}
