...
workflow PGx{
    ...
    call preVcfPharmcatTask{
        input:
            ...
            annotated_vcf_index = merge_phased_vcfs_task.annotated_vcf_index
...
task merge_phased_vcfs_task {
    ...
    command <<<
        ...
        bcftools annotate -a merged_phased.vcf.gz -c FORMAT/GT -Oz -o annotated.vcf.gz --write-index filtered_merged_unphased.vcf.gz
    ...
    output {
        ...
        File annotated_vcf_index = "annotated.vcf.gz.csi"
