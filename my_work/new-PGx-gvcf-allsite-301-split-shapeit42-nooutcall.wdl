...
workflow PGx{
    ...
    call PostPharmCat {
        input:
            ...
            outcall_file = pharmCatTask.outcall_file,
...
task pharmCatTask{
  ...
  command {
    ...
    java -jar /home/stereonote/pharmcat-3.0.1-all.jar -vcf ~{file}  -po outcall.tsv -reporterJson --output-dir .  -reporterCallsOnlyTsv
