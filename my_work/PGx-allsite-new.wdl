...
task PostPharmCat {
    ...
    command <<<
        ...
        python /home/stereonote/script/post_pharmcat_new.py \
            ...
            -sample_id ~{sample_id} 
        python /home/stereonote/script/var_drug.py --valid_ids_path valid_ids.txt
    >>>

    output {
        File output_file = "~{sample_id}.pgx.tsv"
        File unknown_genge_type_file = "~{sample_id}_unknown.pgx.tsv"
...
task gvcf2vcf {
    ...
    runtime {
        req_cpu:4
        req_memory:"8Gi"
        docker_url:"stereonote_hpc/longrui_981433f741f64383a2e5e34212e93617_private:latest"
