...
task gvcf2vcf {
    ...
    command {
        ...
        /home/stereonote/software/gatk-4.2.0.0/gatk --java-options "-Xmx8G -XX:ParallelGCThreads=4" GenotypeGVCFs  -R ${lush_ref_dir}/hg38.fa -O ${sampleID}.allsite.vcf.gz -V ${infile} -stand-call-conf 10 -all-sites --allow-old-rms-mapping-quality-annotation-data
    }
    runtime {
        req_cpu:4
        req_memory:"8Gi"
